...
export default function CivicusMobileShell({
  ...
  return (
    <section className="min-h-screen bg-[#e9eef6]">
      <div className="mx-auto grid min-h-screen w-full max-w-[1380px] gap-8 px-3 py-4 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-8">
        ...
        <div className="flex items-center justify-center lg:justify-end">
          <div className="w-full max-w-[430px] min-h-[720px] rounded-[28px] border border-[#d4dde4] bg-[#efefef] px-5 py-6 shadow-sm lg:max-w-[700px] lg:min-h-[760px] lg:rounded-[34px] lg:border-[#c8d6e2] lg:bg-[#f6f8fb] lg:px-10 lg:py-8 lg:shadow-[0_22px_60px_rgba(16,81,120,0.18)]">
            <header className="text-center">
              <p className="text-[2rem] font-extrabold tracking-tight text-[#0a8ccf] drop-shadow-[0_2px_3px_rgba(8,41,65,0.25)] lg:text-[2.4rem]">
                {APP_NAME}
              </p>
            </header>
